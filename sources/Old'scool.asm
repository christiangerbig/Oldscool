...
; Ausführungszeit 68020: 231 Rasterzeilen
...
; **** Image-Fader ****
if_start_color                  EQU 0
if_color_table_offset           EQU 0
...
cl1_init_branches_pointers_loop2
  ...
  COP_MOVE_QUICK TRUE,SPR6POS
  COP_MOVE_QUICK TRUE,SPR7POS
  COP_MOVE_QUICK TRUE,COP1LCH
  eor.l   d1,d0              ;X-Shift
  COP_MOVE_QUICK TRUE,COP1LCL
...
; -----------------
  CNOP 0,4
wave_scrolltext
  tst.w   wst_enabled(a3)     ;Wave-Scrolltext an ?
...
bv_wobble_sprites_loop2
  ...
  addq.w  #8,a1              ;COP2LCH + COP2LCL überspringen
...
rotation_zoomer_loop2
  ...
  add.w   d1,d4              ;nächste Pixel-Spalte in Bild
  add.w   d0,d5              ;nächste Pixel-Zeile in Bild
  add.l   a2,a1              ;nächste Zeile in CL
  dbf     d6,rotation_zoomer_loop2
  add.w   a3,a4              ;nächste X-Pos in Bild
  sub.w   a7,a5              ;nächste Y-Pos in Bild
...
; ***** Bild *****
  ...
  move.w  #$f0f,d3           ;Maske RGB-Nibbles
...
kh_check_key
  ...
  cmp.b   #KEYBOARD_KEYCODE_F1,d0 ;F1 gedrückt ?
  beq.s   kh_set_xyz_rotation_angle_speed1
  cmp.b   #KEYBOARD_KEYCODE_F2,d0 ;F2 gedrückt ?
  beq.s   kh_set_xyz_rotation_angle_speed2
  cmp.b   #KEYBOARD_KEYCODE_F3,d0 ;F3 gedrückt ?
  beq.s   kh_set_xyz_rotation_angle_speed3
  cmp.b   #KEYBOARD_KEYCODE_F4,d0 ;F4 gedrückt ?
  beq.s   kh_set_xyz_rotation_angle_speed4
  cmp.b   #KEYBOARD_KEYCODE_F5,d0 ;F5 gedrückt ?
  beq.s   kh_set_xyz_rotation_angle_speed5
  cmp.b   #KEYBOARD_KEYCODE_F6,d0 ;F6 gedrückt ?
  beq     kh_set_xyz_rotation_angle_speed6
  cmp.b   #KEYBOARD_KEYCODE_F7,d0 ;F7 gedrückt ?
  beq     kh_set_xyz_rotation_angle_speed7
  cmp.b   #KEYBOARD_KEYCODE_F8,d0 ;F8 gedrückt ?
  beq     kh_set_xyz_rotation_angle_speed8
  cmp.b   #KEYBOARD_KEYCODE_F9,d0 ;F9 gedrückt ?
  beq     kh_set_xyz_rotation_angle_speed9
  cmp.b   #KEYBOARD_KEYCODE_F10,d0 ;F10 gedrückt ?
...
pt_start_horiz_scrolltext
  clr.w   wst_enabled(a3)    ;Wave-Scrolltext an
  rts
  CNOP 0,4
...
; ----------------------------------------
program_version DC.B "$VER: RSE-Old'scool 1.0 (31.8.23)",TRUE
  EVEN
