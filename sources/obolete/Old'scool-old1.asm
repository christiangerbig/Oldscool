...
; -------------------------
  CNOP 0,4
bv_move_lightsource
  move.w  rz_zoom_angle(a3),d0 ;Zoom-Winkel holen
...
bv_rotation
  ...
  move.w  d0,bv_x_rotation_angle(a3) ;X-Winkel retten
  and.w   d3,d1              ;Übertrag entfernen
  add.w   bv_variable_z_rotation_angle_speed(a3),d2 ;nächster Z-Winkel
  move.w  d1,bv_y_rotation_angle(a3) ;Y-Winkel retten
  and.w   d3,d2              ;Übertrag entfernen
  move.w  d2,bv_z_rotation_angle(a3) ;Z-Winkel retten
...
rotation_zoomer_loop2
  move.w  d4,d3              ;X-Pos in Playfield holen
  move.w  d5,d2              ;Y-Pos in Playfield holen
  ...
  add.w   a3,a4              ;nächste X-Pos in Playfield
  sub.w   a7,a5              ;nächste Y-Pos in Playfield
...
ifi_no_restart_fader_angle
  ...
  MOVEF.W pf1_colors_number*3,d6 ;Zähler
